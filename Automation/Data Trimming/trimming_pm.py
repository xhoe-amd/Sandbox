...
csv_file = "FS_AC_HSD_GFX2200_60Hz_TT_Run1_PM.csv"
target_data = "GPU0 SVI3 Telemetry Power VDDCR_GFX"
...
for row_idx, row in enumerate(rows):
    for col_idx, cell in enumerate(row):
        if cell == target_data:
            ...
            start_row = row_idx + 1  # start BELOW the cell
            break
...
min_sample_size = 5
max_sample_size = 25
sample_size = min_sample_size # max(min_sample_size, min(int(len(data) ** 0.5), max_sample_size))
